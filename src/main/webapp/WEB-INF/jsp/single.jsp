                    ...
                    <div class="comments my-5">
                        ...
                        <div class="comments-grids mt-4">
                            <div class="media mt-4">
                                <img class="mr-3" src="${pageContext.request.contextPath}/resources/images/te1.jpg" class="img-fluid media-img" alt="image">
                            ...
                            <div class="media mt-sm-5 mt-3">
                                <a class="pr-3" href="#">
                                    <img src="${pageContext.request.contextPath}/resources/images/te2.jpg" class="img-fluid media-img" alt="image">
                                </a>
                                <div class="media-body comments-grid-right">
                                    <h4>Watson</h4>
                                    <ul class="my-2">
                            ...
                            <div class="posts-grids">
                                <div class="row posts-grid mt-4">
                                    <div class="col-lg-4 col-sm-4 posts-grid-left pr-0">
                                        <a href="/single">
                                            <img src="${pageContext.request.contextPath}/resources/images/t2.jpg" alt=" " class="img-fluid img-thumbnail" />
                                        </a>
                                    </div>
                                ...
                                <div class="row posts-grid mt-4">
                                    <div class="col-lg-4 col-sm-4 posts-grid-left pr-0">
                                        <a href="/single">
                                            <img src="${pageContext.request.contextPath}/resources/images/t1.jpg" alt=" " class="img-fluid img-thumbnail" />
                                        </a>
                                    </div>
                                    <div class="col-lg-8 col-sm-8 posts-grid-right mt-sm-0 mt-4">
                                        <h4>
