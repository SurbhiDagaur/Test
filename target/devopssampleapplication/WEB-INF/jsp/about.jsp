...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/slider.css" type="text/css" media="all" />
    <!-- Style-CSS -->
    <!-- font-awesome-icons -->
...
<body>
        ...
        <div class="container py-md-5">
            <div class="feature-grids row mt-3">
                <div class="col-lg-6 ab-content-img">
                    <img src="${pageContext.request.contextPath}/resources/images/ab.jpg" alt="" class="img-fluid image1">
                </div>
        ...
        <div class="container py-md-5">
            <div class="row">
                ...
                <div class="col-lg-3 progress-content-img mt-4">
                    <img src="${pageContext.request.contextPath}/resources/images/skill1.jpg" alt="" class="img-fluid image1">
                </div>
                <div class="col-lg-3 progress-content-img mt-4">
                    <img src="${pageContext.request.contextPath}/resources/images/skill2.jpg" alt="" class="img-fluid image1">
                </div>
        ...
        <div class="container py-md-5 py-3">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6 mb-5">
                    <div class="grid">
                        <img src="${pageContext.request.contextPath}/resources/images/banner3.jpg" alt="" class="img-fluid">
                        <div class="info p-4">
                ...
                <div class="col-lg-4 col-sm-6 mb-5">
                    <div class="grid">
                        <img src="${pageContext.request.contextPath}/resources/images/banner1.jpg" alt="" class="img-fluid">
                        <div class="info p-4">
                ...
                <div class="col-lg-4 col-sm-6 mb-5">
                    <div class="grid">
                        <img src="${pageContext.request.contextPath}/resources/images/banner2.jpg" alt="" class="img-fluid">
                        <div class="info p-4">
        ...
        <div class="container py-xl-5 py-lg-3" id="services">
            <div class="row">
                <div class="col-lg-5 welcome-left">
                    ...
                    <h3 class="title-w3ls mt-2 mb-3">Services weâre Provided</h3>
                    ...
                    <div class="row">
                        <div class="col-sm-4 service-1-w3pvt serve-gd3">
                            <div class="serve-grid test-gd mt-4">
                                <img src="${pageContext.request.contextPath}/resources/images/t1.jpg" alt="" class="img-fluid image1">
                                <p class="mt-2">Partner1 </p>
                            </div>
                            <div class="serve-grid test-gd mt-4">
                                <img src="${pageContext.request.contextPath}/resources/images/t2.jpg" alt="" class="img-fluid image1">
                                <p class="mt-2">Partner2 </p>
                            </div>
                            <div class="serve-grid test-gd mt-4">
                                <img src="${pageContext.request.contextPath}/resources/images/t3.jpg" alt="" class="img-fluid image1">
                        ...
                        <div class="col-sm-4 service-1-w3pvt serve-gd1">
                            <div class="serve-grid test-gd mt-4">
                                <img src="${pageContext.request.contextPath}/resources/images/t4.jpg" alt="" class="img-fluid image1">
    ...
    <div class="copy-right">
        <div class="container">
            <div class="row">
                <p class="copy-right-grids text-md-left text-center my-sm-4 my-4 col-md-6">Â© 2019 Repay. All Rights Reserved | Design by
